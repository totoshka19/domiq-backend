...
- **S3-совместимое хранилище** (Cloudflare R2) — фото объявлений и аватары
...
| Фоновые задачи | Render (Celery worker) |
...
| `S3_ENDPOINT_URL` | Эндпоинт Cloudflare R2 |
| `S3_ACCESS_KEY` / `S3_SECRET_KEY` | Ключи R2 |
